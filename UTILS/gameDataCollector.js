        ...
        try {
            const createQuery = `
                CREATE TABLE IF NOT EXISTS ml_game_data (
                    ...
                    bet_amount DECIMAL(24,2) NOT NULL,
                    payout DECIMAL(24,2) NOT NULL,
                    won BOOLEAN NOT NULL,
                    net_result DECIMAL(24,2) NOT NULL,
                    multiplier_hit DECIMAL(10,4) NOT NULL,
                    user_wealth_before DECIMAL(20,2) NOT NULL,
                    user_wealth_after DECIMAL(20,2) NOT NULL,
