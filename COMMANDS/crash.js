/**
 * 🚀 HYBRID ENGINE-POWERED CRASH COMMAND
 * Combines original crash mechanics with new Engine system
...
module.exports = {
  ...
  async execute(interaction) {
    ...
    try {
      ...
      const engineGameResult = await GameEngine.startGame('crash', userId, guildId, betAmount, {
        mode: selectedMode,
      ...
      await analyticsEngine.recordGameEvent(userId, guildId, 'crash_start', {
        gameId: engineGameId,
        betAmount: betAmount,
        mode: selectedMode,
      ...
      await startCrashGame(interaction, selectedMode, 0, {
        engineGameId: engineGameId,
        engineSettings: settings
      }); // Pass engine data to game logic
