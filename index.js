    ...
    for (const file of commandFiles) {
        try {
            ...
            if ('data' in command && 'execute' in command) {
                ...
                // Admin commands removed - moved to UAS-Standalone-Bot
            } else {
...
client.on('interactionCreate', async interaction => {
    ...
    if (interaction.isChatInputCommand()) {
        ...
        // Cog management removed - moved to UAS-Standalone-Bot
    ...
    // Handle select menu interactions
        ...
        try {
            ...
            // Setup wizard removed - moved to UAS-Standalone-Bot
            ...
            // NOTE: Cog updater select menu handler (update_cog_select) moved to UAS-Standalone-Bot
            // NOTE: Cog management select menu handler (cog_select) moved to UAS-Standalone-Bot
    ...
    // Handle button interactions
        ...
        try {
            ...
            */
            ...
            // NOTE: Cog updater button handlers (update_*) moved to UAS-Standalone-Bot
            // NOTE: Cog management button handlers (cog_*) moved to UAS-Standalone-Bot
